...
const postAnnouncementReducer = (state = PostingState , action)=> {
    switch(action.type){
    
        case POSTING_ANNOUNCEMENT_REQUEST:
          return{
            ...state,
            loading : true
          }  
        case POSTING_ANNOUNCEMENT_SUCCESS:
            return{
                loading : false,
                report : action.payload,
                error: ''
            }
        case POSTING_ANNOUNCEMENT_ERROR:
            return{
                loading : false,
                report : '',
...
export default postAnnouncementReducer;