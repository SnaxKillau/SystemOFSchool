...
const deleteFoundReducer = (state = PostState , action)=> {
    switch(action.type){
    
        case  DELETE_FOUND_REQUEST:
          return{
            ...state,
            loading : true
          }  
        case DELETE_FOUND_SUCCESS:
            return{
                loading : false,
                report : action.payload,
                error: ''
            }
        case DELETE_FOUND_ERORR:
            return{
                loading : false,
                report : '',
...
export default deleteFoundReducer;